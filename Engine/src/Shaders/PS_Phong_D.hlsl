//Phong pixel shader with diffuse mapping.
            ...
            float2 texCoord : TEXCOORD) : SV_Target
{
    ...
    float3 phong = AmbientLight.rgb * AmbientLight.a * (float3) diffuseColor +
               CalculateDirectionalLights(normal, viewSpacePos, diffuseColor.rgb, shininess) +
               CalculatePointLights(normal, viewSpacePos, diffuseColor.rgb, shininess);
